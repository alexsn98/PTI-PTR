...
Route::get('home/admin/utilizadorInfo/{idUtilizador}', 'HomeController@getUtilizadorInfo')->middleware('admin');
Route::get('home/admin/getUsers/{cargo}', 'HomeController@filtarUtilizadores')->middleware('admin');
